...
mainFrame.Size = UDim2.new(0, 180, 0, 420) -- Increased height for dual buttons
mainFrame.Position = UDim2.new(0.5, -90, 0.5, -210)
...
blackFrame.Size = UDim2.new(0, 190, 0, 430)
...
petNameLabel.Position = UDim2.new(0.05, 0, 0, 0)
...
petListBtn.Position = UDim2.new(0.65, 0, 0, 0)
...
petDialogBtn.Position = UDim2.new(0.05, 0, 0.12, 0)
...
randomPetBtn.Position = UDim2.new(0.05, 0, 0.20, 0)
...
for i, prefix in ipairs(prefixes) do
   ...
   prefixButton.Position = UDim2.new(0.05 + (i-1)*0.23, 0, 0.28, 0)
...
infoBox.Position = UDim2.new(0.05, 0, 0.38, 0)
...
spamContainer.Position = UDim2.new(0.05, 0, 0.70, 0)
...
spamStatus.Position = UDim2.new(0.05, 0, 0.75, 0)
...
-- === DUAL OKAY BUTTONS ===
-- Left Okay Button (Green)
local leftOkayBtn = Instance.new("TextButton")
leftOkayBtn.Size = UDim2.new(0.43, 0, 0, 20)
leftOkayBtn.Position = UDim2.new(0.05, 0, 0.85, 0)
leftOkayBtn.Text = "Okay!"
leftOkayBtn.Font = Enum.Font.FredokaOne
leftOkayBtn.TextSize = 11
leftOkayBtn.BackgroundColor3 = Color3.fromRGB(30, 105, 210)
leftOkayBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
leftOkayBtn.AutoButtonColor = true
leftOkayBtn.Parent = mainContent
Instance.new("UICorner", leftOkayBtn).CornerRadius = UDim.new(0, 6)

-- Right Okay Button (Red)
local rightOkayBtn = Instance.new("TextButton")
rightOkayBtn.Size = UDim2.new(0.43, 0, 0, 20)
rightOkayBtn.Position = UDim2.new(0.52, 0, 0.85, 0)
rightOkayBtn.Text = "Okay!"
rightOkayBtn.Font = Enum.Font.FredokaOne
rightOkayBtn.TextSize = 11
rightOkayBtn.BackgroundColor3 = Color3.fromRGB(180, 30, 30)
rightOkayBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
rightOkayBtn.AutoButtonColor = true
rightOkayBtn.Parent = mainContent
Instance.new("UICorner", rightOkayBtn).CornerRadius = UDim.new(0, 6)
...
-- Left Okay button (Green) - Show Pet Dialog
leftOkayBtn.MouseButton1Click:Connect(showPetDialog)

-- Right Okay button (Red) - Show Toy Dialog
rightOkayBtn.MouseButton1Click:Connect(showToyDialog)
...
task.spawn(function()
   ...
   print("NEW: Dual Okay buttons - Left (Blue) spawns pet, Right (Red) spawns toy!")
end)
...
print("3. DUAL OKAY BUTTONS - Left (Blue) = Pet, Right (Red) = Toy")
print("4. SPAM POP-UPS toggle - Spams ~100+ dialogs per second!")
print("5. All pet versions: MFR, MR, MF, M, NFR, NF, NR, N, FR, F, R, No Pot")
print("6. EDITOR TAB: Customize dialog messages with 4 presets!")
print("7. TOY SYSTEM: 4 premium toys with inventory support!")
print("=" .. string.rep("=", 50))